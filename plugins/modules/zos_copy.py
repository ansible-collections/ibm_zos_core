...
options:
  ...
  backup_file:
    description:
      ...
      - If C(dest) is a data set member and C(backup_file) is not provided, the data set
        member will be backed up to the same partitioned data set with the name "MEMBAK".
    required: false
    type: str
  force:
    description:
