...
resource_type
  ...
  :literal:`gdg` refers to Generation Data Groups. The module searches based on the GDG base name.
...
empty
  A GDG attribute, only valid when :literal:`resource\_type=gdg`.

  If provided, will search for data sets with :emphasis:`empty` attribute set as provided.
...
extended
  ...
  If provided, will search for data sets with :emphasis:`extended` attribute set as provided.
...
fifo
  ...
  If provided, will search for data sets with :emphasis:`fifo` attribute set as provided.
...
limit
  ...
  If provided, will search for data sets with :emphasis:`limit` attribute set as provided.
...
purge
  ...
  If provided, will search for data sets with :emphasis:`purge` attribute set as provided.
...
scratch
  ...
  If provided, will search for data sets with :emphasis:`scratch` attribute set as provided.
