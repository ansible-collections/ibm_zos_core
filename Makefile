...
# ==============================================================================
# Setup the python virtual environment, the default name is 'venv'. You can
# override the default name by exporting the variable VENV:
#    (1) export VENV=venv-2.11
#    (2) make vsetup req=requirements-ac-2.11.12.txt
# @test -d $(VENV) || $(HOST_PYTHON) -m venv $(VENV)
# ==============================================================================
## Create a python virtual environment (venv) based on the hosts python3
## Options:
##     req - your requirements.txt else a default one will be used
## Example:
##     $ make vsetup
##     $ make vsetup req=path/to/requirements.txt
##
## Override the default virtual environment name 'venv' by exporting var VENV
