...
stdout:
  ...
  operation:
    ...
    set_dynamic, set_static, check_format:
       description: Returns one the following,
       1. Set to DYNAMIC
       2. Set to STATIC
       3. "DYNAMIC"
       4. "STATIC"
...
def main():
    ...
    arg_defs = dict(
        ...
        persistent=dict(arg_type='dict', required=False, default=None,
            options=dict(
        ...
        encoding=dict(arg_type='str', default="IBM-1047"),
        mutually_exclusive=[
            # batch
            ['batch', 'dsname'],
            ['batch', 'volume'],
