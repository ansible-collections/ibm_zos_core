...
- Support to special characters (#, @, $, \- ) in different options like data set names and commands is not supported, some modules support them but ask the user to escape them. Read each module documentation for further details.
