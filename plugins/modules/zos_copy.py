...
notes:
    ...
    - To use this module, you must have READ authority to the RACF FACILITY
      resource class profile MVS.MCSOPER.ZOAU. If your system uses a different
      security product, consult that product's documentation to configure the
