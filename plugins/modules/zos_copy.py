...
options:
  ...
  backup:
    description:
      ...
      - Note that a PDS/PDSE member can not be backed up to the same PDS/PDSE.
        If destination is a partitioned data set member, the entire partitioned
        data set will backed up.
    type: bool
    default: false
    required: false
  backup_file:
