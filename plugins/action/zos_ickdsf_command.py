...
class ActionModule(ActionBase):
    '''
    Action plugin to process input to zos_ickdsf_command module, then pass
    the output to zos_mvs_raw, logging output to an HTML file if specified
    '''
    def run(self, tmp=None, task_vars=None):
        '''
        Runs Action plugin to process input to zos_ickdsf_command and zos_mvs raw
        ...
        result = self._execute_module(
            module_name='ibm.ibm_zos_core.zos_ickdsf_command',
