...
* **`gather_diagnostics_gather_controller`**
...
* **`gather_diagnostics_save_controller_log`**
...
* **`gather_diagnostics_output_dir`**
    * **Description**: Controls where the role creates YAML reports from managed node and controller. In AAP, defaults to artifacts directory; otherwise uses controller's home directory.
    * **Type**: `str`
