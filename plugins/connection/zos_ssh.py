...
if version_major == 2 and version_minor >= 11:
    ...
    '''
    try:
        # Load z/OS connection plugin for versions of Ansible greater equal to 2.10.x
        from ansible_collections.ibm.ibm_zos_core.plugins.connection.zos_ssh_2_10 import Connection
    except ImportError:
        pass
else:
    DOCUMENTATION = '''
    ...
    '''
    try:
        # Load legacy z/OS connection plugin for versions of Ansible lesser than 2.10
        from ansible_collections.ibm.ibm_zos_core.plugins.connection.zos_ssh_2_9 import Connection
    except ImportError:
        pass
